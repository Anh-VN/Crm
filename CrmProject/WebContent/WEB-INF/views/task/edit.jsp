...
<div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="<c:url value="${ UrlConstants.URL_TASK_EDIT }" />" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="YYYY/MM/DD"
                                            class="form-control form-control-line" name="startDate" value="${task.startDate }" > </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="YYYY/MM/DD"
                                            class="form-control form-control-line" name="endDate" value="${task.endDate }" > </div>
                                </div>           
                               <div class="form-group">
                                    ...
                                    <div class="col-md-3">
	                                    <select name="generalTaskId" class="form-control form-control-line">
											<c:forEach items="${ generalTasks }" var="item">
												<option value="${ item.id }" ${ task.generalTaskId == item.id ? 'selected' : '' }>${ item.name }</option>
											</c:forEach>
								        </select>
                                    </div>
                                </div>
